		...
		public function render_content() {
			...
			$important_links = array(
				'theme_instructions' => array(
					'link'  => esc_url( 'https://catchthemes.com/themes/catch-sketch/#theme-instructions' ),
					'text'  => esc_html__( 'Theme Instructions', 'catch-sketch' ),
					),
				'support' => array(
					'link'  => esc_url( 'https://catchthemes.com/support/' ),
					'text'  => esc_html__( 'Support', 'catch-sketch' ),
					),
				'changelog' => array(
					'link'  => esc_url( 'https://catchthemes.com/changelogs/catch-sketch-theme/' ),
					'text'  => esc_html__( 'Changelog', 'catch-sketch' ),
					),
				'facebook' => array(
					'link'  => esc_url( 'https://www.facebook.com/catchthemes/' ),
					'text'  => esc_html__( 'Facebook', 'catch-sketch' ),
					),
				'twitter' => array(
					'link'  => esc_url( 'https://twitter.com/catchthemes/' ),
					'text'  => esc_html__( 'Twitter', 'catch-sketch' ),
					),
				'gplus' => array(
					'link'  => esc_url( 'https://plus.google.com/+Catchthemes/' ),
					'text'  => esc_html__( 'Google+', 'catch-sketch' ),
					),
				'pinterest' => array(
					'link'  => esc_url( 'http://www.pinterest.com/catchthemes/' ),
					'text'  => esc_html__( 'Pinterest', 'catch-sketch' ),
					),
			);
		...
		public function render_content() {
			$dropdown = wp_dropdown_categories(
				array(
					...
					'hide_if_empty'    => false,
					'show_option_all'  => esc_html__( 'All Categories', 'catch-sketch' ),
				)
			);
			...
			echo '<p class="description">' . esc_html__( 'Hold down the Ctrl (windows) / Command (Mac) button to select multiple options.', 'catch-sketch' ) . '</p>';
		}
	}
